...
experimentApp.controller('ExperimentController',
  function ExperimentController($scope, $timeout, preloader) {
    ...
    $scope.stimuli_sets = [
      ...
      // [1, 2, 3],
      [13, 5, 9, 1, 6, 14, 2, 10, 11, 3, 7, 15, 16, 12, 4, 8], 
      [5, 9, 1, 6, 14, 2, 10, 11, 3, 7, 15, 16, 12, 4, 8, 13], 
      [9, 1, 6, 14, 2, 10, 11, 3, 7, 15, 16, 12, 4, 8, 13, 5], 
      [1, 6, 14, 2, 10, 11, 3, 7, 15, 16, 12, 4, 8, 13, 5, 9], 
      [6, 14, 2, 10, 11, 3, 7, 15, 16, 12, 4, 8, 13, 5, 9, 1], 
      [14, 2, 10, 11, 3, 7, 15, 16, 12, 4, 8, 13, 5, 9, 1, 6], 
      [2, 10, 11, 3, 7, 15, 16, 12, 4, 8, 13, 5, 9, 1, 6, 14], 
      [10, 11, 3, 7, 15, 16, 12, 4, 8, 13, 5, 9, 1, 6, 14, 2], 
      [11, 3, 7, 15, 16, 12, 4, 8, 13, 5, 9, 1, 6, 14, 2, 10], 
      [3, 7, 15, 16, 12, 4, 8, 13, 5, 9, 1, 6, 14, 2, 10, 11], 
      [7, 15, 16, 12, 4, 8, 13, 5, 9, 1, 6, 14, 2, 10, 11, 3], 
      [15, 16, 12, 4, 8, 13, 5, 9, 1, 6, 14, 2, 10, 11, 3, 7], 
      [16, 12, 4, 8, 13, 5, 9, 1, 6, 14, 2, 10, 11, 3, 7, 15], 
      [12, 4, 8, 13, 5, 9, 1, 6, 14, 2, 10, 11, 3, 7, 15, 16], 
      [4, 8, 13, 5, 9, 1, 6, 14, 2, 10, 11, 3, 7, 15, 16, 12], 
      [8, 13, 5, 9, 1, 6, 14, 2, 10, 11, 3, 7, 15, 16, 12, 4], 
    ]
