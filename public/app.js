...
experimentApp.controller('ExperimentController',
  function ExperimentController($scope, $timeout, preloader) {
    ...
    $scope.stimuli_sets = [
      ...
      // [1, 2, 3],
      [9, 13, 5, 1, 14, 2, 6, 10, 7, 11, 15, 3, 16, 12, 4, 8], 
      [13, 5, 1, 14, 2, 6, 10, 7, 11, 15, 3, 16, 12, 4, 8, 9],
      [5, 1, 14, 2, 6, 10, 7, 11, 15, 3, 16, 12, 4, 8, 9, 13],
      [1, 14, 2, 6, 10, 7, 11, 15, 3, 16, 12, 4, 8, 9, 13, 5],
      [14, 2, 6, 10, 7, 11, 15, 3, 16, 12, 4, 8, 9, 13, 5, 1],
      [2, 6, 10, 7, 11, 15, 3, 16, 12, 4, 8, 9, 13, 5, 1, 14],
      [6, 10, 7, 11, 15, 3, 16, 12, 4, 8, 9, 13, 5, 1, 14, 2],
      [10, 7, 11, 15, 3, 16, 12, 4, 8, 9, 13, 5, 1, 14, 2, 6],
      [7, 11, 15, 3, 16, 12, 4, 8, 9, 13, 5, 1, 14, 2, 6, 10],
      [11, 15, 3, 16, 12, 4, 8, 9, 13, 5, 1, 14, 2, 6, 10, 7],
      [15, 3, 16, 12, 4, 8, 9, 13, 5, 1, 14, 2, 6, 10, 7, 11],
      [3, 16, 12, 4, 8, 9, 13, 5, 1, 14, 2, 6, 10, 7, 11, 15],
      [16, 12, 4, 8, 9, 13, 5, 1, 14, 2, 6, 10, 7, 11, 15, 3],
      [12, 4, 8, 9, 13, 5, 1, 14, 2, 6, 10, 7, 11, 15, 3, 16],
      [4, 8, 9, 13, 5, 1, 14, 2, 6, 10, 7, 11, 15, 3, 16, 12],
      [8, 9, 13, 5, 1, 14, 2, 6, 10, 7, 11, 15, 3, 16, 12, 4],
    ]
